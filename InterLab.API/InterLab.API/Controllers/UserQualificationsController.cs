...
namespace InterLab.API.Controllers
{
    ...
    public class UserQualificationsController : Controller
    {
        private readonly IQualificationService _qualificationService;
        private readonly IMapper _mapper;

        public UserQualificationsController(IQualificationService qualificationService, IMapper mapper)
        {
        ...
        [HttpGet]
        public async Task<IEnumerable<QualificationResource>> GetAllByUserId(int userId)
        {
